...
RUN curl -fsSL https://github.com/openshift/origin/releases/download/v1.3.1/openshift-origin-client-tools-v1.3.1-dad658de7465ba8a234a4fb40b5b446a45a4cee1-linux-64bit.tar.gz | tar xzf - -C /usr/bin/ --strip-components 1 openshift-origin-client-tools-v1.3.1-dad658de7465ba8a234a4fb40b5b446a45a4cee1-linux-64bit/oc

# Clean up and change ownership
RUN chown -R jenkins-slave:0 /opt/jenkins-slave && \
    rm -rf /tmp/* && \
    yum clean all
